...
이번 프로젝트는 단순히 주피터 안에서 끝나는 모델링이 아니라, 실제 사용자가 쓸 수 있는 웹 서비스로 구현해 보았다는 점에서 큰 의미가 있었습니다.
...
<img width="224" height="224" alt="유튜브 시연영상 QR코드" src="https://github.com/user-attachments/assets/5c099970-5c85-448d-816c-5e015584ce67" />

| 항목 | 내용 |
| :--- | :--- |
| **제출 형태** | YouTube 링크 |
| **영상 길이** | 약 1분 30초 |
| **내용** | **AI 폐기물 분류 시스템 시연**<br>1. **웹캠 실시간 분류:** 웹캠을 켜고 실제 폐기물을 카메라에 비춰 실시간 분류 결과 시연.<br>2. **이미지 파일 업로드:** 이미지 파일을 업로드하여 분류 결과(클래스, 신뢰도) 및 가이드 표시. |
| **예시 링크** | [https://youtu.be/efficientnet_waste_demo](https://youtu.be/0DN0vSz1674) |
